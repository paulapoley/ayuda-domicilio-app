    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
             ...
             <!-- Tipo profesional -->
             <div class="mt-4">
                <x-label for="tipoProfesional" :value="__('Tipo de profesional:')" />

                <x-select id="tipoProfesional" name="tipoProfesional" required>
                    <option value="">{{__('Elige una opción')}}</option>
                    <option value="1" @if (old('genero') == 1) selected @endif>{{__('Enfermero/a')}}</option>
                    <option value="0" @if (old('genero') == 0) selected @endif>{{__('Auxiliar')}}</option>
                </x-select>
            </div>

                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <table class="min-w-max w-full table-auto">
                        ...
                        <tr class="bg-gray-200 text-gray-900 uppercase text-sm leading-normal">
                            ...
                            @endif
                            <th class="py-3 px-6 text-left">Fecha hora inicio</th>
                            <th class="py-3 px-6 text-left">Fecha hora fin</th>
                        ...
                        @foreach ($citas as $cita)
                            <tr class="border-b border-gray-200">
                                ...
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">
                                        <span class="font-medium">{{$cita->profesional->user->name}}</span>
                                    </div>
                                </td>
                                @endif
                                @if(\Illuminate\Support\Facades\Auth::user()->tipo_usuario_id != 2)
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">
                                        <span class="font-medium">{{$cita->familiar->user->name}}</span>
                                    </div>
                                </td>
                                @endif
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">
                                        <span class="font-medium">{{$cita->fechaHoraInicio->format('Y/m/d H:i:s')}}</span>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">
                                        <span class="font-medium">{{$cita->fechaHoraFin->format('Y/m/d H:i:s')}}</span>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">
                                        <span class="font-medium">{{$cita->descripcion}}</span>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">
                                        <span class="font-medium">{{$cita->observaciones}}</span>
                                    </div>
                                </td>
